    ...
    <div className="space-y-6">
      <section className="ms-card p-6 md:p-8">
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            ...
            <h1 className="mt-2 font-display text-4xl font-black text-slate-950 md:text-5xl">Panier</h1>
      ...
      {lines.length === 0 ? (
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          <form action="/api/cart/update" method="post" className="lg:col-span-2">
            <section className="ms-card overflow-hidden p-0">
              <div className="divide-y divide-slate-200/80">
                {lines.map((line) => (
                  <article key={line.product.id} className="flex flex-wrap gap-4 p-4 md:flex-nowrap md:p-5">
                    ...
                    <div className="flex-1">
                      <div className="flex flex-wrap items-start justify-between gap-3">
                        <div>
                          <Link href={`/boutique/${line.product.slug}`} className="font-display text-xl font-black text-slate-950">
                            {line.product.name}
                          </Link>
                      ...
                      <div className="mt-4 flex flex-wrap items-end justify-between gap-3">
                        ...
                        <button
                          ...
                          className="ms-btn-secondary border-rose-300 bg-rose-50 text-rose-900 hover:bg-rose-100"
                        >
                          Supprimer
                        </button>
                      </div>
          ...
          <aside className="ms-card-subtle p-6">
